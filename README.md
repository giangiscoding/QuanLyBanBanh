...
- [ ] **Giai đoạn 6 — Hoàn thiện:** Testing tự động, Docker hóa toàn bộ, CI/CD, triển khai

> ⚙️ **Trạng thái hiện tại:** Toàn bộ **REST API backend** (10 module) và **giao diện frontend** đã hoàn thiện; cả hai đều build/type-check sạch. Phần còn lại là testing tự động và triển khai.
